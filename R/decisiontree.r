 ...
 if (ans == "n" | ans == "N"){
  ...
  cat("\n")
      ...
      cat("\n")
           ...
           cat(" life = up to",1.5*X, "months, but not exceeding",X+6,"months; or if      \n")
           cat(" refrigerated, Proposed retest period or shelf life= up to",X+3,"months   \n") 
           cat("--------------------------------------------------------------------------\n")
           cat("\n")
           statistical()
           }
           ...
           cat("                              <<Suggestion>>                              \n")
           cat(" If backed by relevant supporting data : Proposed retest period or shelf  \n") 
           cat(" life = up to",2*X, "months","but not exceeding",X+12,"months; or if      \n") 
           cat(" refrigerated, Proposed retest period or shelf life = up to",1.5*X ,     "\n")
           cat(" months, but not exceeding",X+6,"months",                                "\n")
           cat("--------------------------------------------------------------------------\n") 
           cat("\n")
           statistical()
              }
      ...
      cat("\n") 
           ...
           cat(" shelf life = up to", 2*X, "months,but not exceeding",X+12,"months; or if \n") 
           cat(" refrigerated, Proposed retest period or shelf life = up to", 1.5*X,"     \n")
           cat(" months but not exceeding",X+6,"months                                    \n")
           cat("--------------------------------------------------------------------------\n") 
           cat("\n")
  ...
  cat("\n")
       if (ans == "n" | ans == "N"){
          ...
          cat("\n")
               ...
               cat("\n")
                   ...
                   cat(" retest period or shelf life = up to",1.5*X,"months, but not exceeding    \n")
                   cat("",X+6,"months                                                             \n")                                                         
                   cat("--------------------------------------------------------------------------\n")
                   cat("\n")
                   statistical()
               ...
               cat("--------------------------------------------------------------------------\n")
               cat("                              <<Suggestion>>                              \n")
               cat(" No extrapolation; shorter retest periodor shelf life can be called for;  \n")
       ...
       cat("\n")
            ...
            cat(" excursions can be called for; statistical analysisif long-term data      \n")
